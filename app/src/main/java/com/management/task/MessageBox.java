...
public class MessageBox {
    public static void showOkMessage(Context context, String title, String msg) {
        showOkMessage(context, title, msg, new MessageBox.OnOkListener() {
            @Override
            public void onOk() {
            }
        });
    ...
    public static void showOkMessage(Context context, String title, String msg, final MessageBox.OnOkListener listener) {
    ...
    public static void showYesNoMessage(Context context, String title, String msg, String yes, String no,
                                        final MessageBox.OnYesNoListener listener) {
    ...
    public interface OnOkCancelListener {
        void onYesNo(boolean isYes,String msg);
    }
    public interface OnOkCancelListenerWithDialog {
        void onYesNo(boolean isYes,String msg,Dialog dialog);
    }
}
